...
- Python (optional: for wordlist conversion) (https://www.python.org/downloads/)
...
- *Step 1)* Create a password list and convert it to a json format
  ...
  - ##### Option 1: Using python
    - If python is in your path you can use the python script included in the repo [(link)](https://github.com/drewstaylor/satoshis-treasure-brute-forcer/blob/master/tools/wordlist_to_json.py). Simply rename your file to `wordlist.txt`, place it in the `tools` folder and run the json conversion script.
