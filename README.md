...
*E.g. The script yields about 76,265 45 char length passwords per minute / 1,271 45 char length passwords per second when run from a reasonably powered machine*
